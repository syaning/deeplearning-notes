...
def Emojify_V2(input_shape, word_to_vec_map, word_to_index):
    ...
    # Define sentence_indices as the input of the graph, it should be of shape
    # input_shape and dtype 'int32' (as it contains indices).
    ...
    # Propagate sentence_indices through your embedding layer, you get back
    # the embeddings
    ...
    # Be careful, the returned output should be a single hidden state, not a
    # batch of sequences.
