...
def sample(parameters, char_to_ix, seed):
    ...
    # trained model), which helps debugging and prevents entering an infinite
    # loop.
    counter = 0
    ...
    while (idx != newline_character and counter != 50):
        ...
        # Step 3: Sample the index of a character within the vocabulary from
        # the probability distribution y
    ...
    for j in range(num_iterations):
        ...
        if j % 2000 == 0:
            ...
            for name in range(dino_names):
                ...
                # To get the same result for grading purposed, increment the
                # seed by one.
                seed += 1
