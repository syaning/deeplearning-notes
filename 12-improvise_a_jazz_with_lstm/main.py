...
def music_inference_model(LSTM_cell, densor, n_values=78, n_a=64, Ty=100):
    ...
    # Step 1: Create an empty list of "outputs" to later store your predicted
    # values
    outputs = []
    ...
    for t in range(Ty):
        ...
        # Step 2.B: Apply Dense layer to the hidden state output of the
        # LSTM_cell (≈1 line)
        out = densor(a)

        # Step 2.C: Append the prediction "out" to "outputs". out.shape =
        # (None, 78)
        outputs.append(out)
...
def predict_and_sample(inference_model, x_initializer=x_initializer, a_initializer=a_initializer,
    ...
    # Step 1: Use your inference model to predict an output sequence given
    # x_initializer, a_initializer and c_initializer.
    pred = inference_model.predict([x_initializer, a_initializer,
                                    c_initializer])
    # Step 2: Convert "pred" into an np.array() of indices with the maximum
    # probabilities
